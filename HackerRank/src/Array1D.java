...
public class Array1D {
	...
	public static boolean isSolvable(int[] array, int m, int i) {
	    /* Base Cases */
	    if (i < 0 || array[i] == 1) {
	        return false;
	    } else if (i >= array.length -1 || i + m >= array.length ) { // i should reach last element or with a jump it should cross the boundry
	        return true;
	    }
